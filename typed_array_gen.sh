...
erb pgtype_array_type=JSONBArray pgtype_element_type=JSONB go_array_types=[]string element_type_name=jsonb text_null=NULL binary_format=true typed_array.go.erb > jsonb_array.go
